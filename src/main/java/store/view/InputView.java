...
public class InputView {
    ...
    private static final String ADD_PROMOTION_CHOICE = "\n현재 %s은(는) %d개를 무료로 더 받을 수 있습니다. 추가하시겠습니까? (Y/N)\n";
    private static final String REMOVE_NON_PROMOTION_CHOICE = "\n현재 %s %d개는 프로모션 할인이 적용되지 않습니다. 그래도 구매하시겠습니까? (Y/N)\n";
    private static final String MEMBERSHIP_DISCOUNT_CHOICE = "\n멤버십 할인을 받으시겠습니까? (Y/N)\n";
    private static final String SHOP_AGAIN_CHOICE = "\n감사합니다. 구매하고 싶은 다른 상품이 있나요? (Y/N)\n";
